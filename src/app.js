...
async function addUsers() {
    for (let dummyUser of dummyData.users) {
        ...
        // console.log(`_id = ${dbUser._id}, name = ${dbUser.fullName}`);

        // Save it to the DB
        let us = await dbUser.save();
        console.log(`User saved! _id = ${us._id}, name = ${dbUser.fullName}`);
...
async function runQueries() {
    ...
    // const usernameToFind = 'aquamarine0'
    ...
    // const petNumberToFind = '0b4d168b-0196-4e7d-b86e-edb94c9f560f';
